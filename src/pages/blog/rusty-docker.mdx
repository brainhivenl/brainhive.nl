...
intro: |
    Before founding brainhive, I picked Go as my programming language of choice (for most backend projects).
    But I started using Rust more often in the last couple of months.
